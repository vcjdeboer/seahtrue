...
for (seahorse_file in seahorse_files){
  ...
  test_that("Test 'Raw' data derived from Seahorse XFe96 analyser 'Raw' Excel datasheet.", {
    ...
    expect_type(xf_raw$well_temperature, "double")
    expect_type(xf_raw$O2_is_valid, "character")
    expect_type(xf_raw$O2_mmHg, "double")
    expect_type(xf_raw$O2_light_emission, "double") # Note: this is actually an integer and will be converted during preprocessing.
    expect_type(xf_raw$O2_dark_emission, "double") # Note: this is actually an integer and will be converted during preprocessing.
    expect_type(xf_raw$O2_ref_light, "double") # Note: this is actually an integer and will be converted during preprocessing.
    expect_type(xf_raw$O2_ref_dark, "double") # Note: this is actually an integer and will be converted during preprocessing.
    expect_type(xf_raw$O2_em_corr, "double")
    expect_type(xf_raw$pH_is_valid, "character")
    expect_type(xf_raw$pH, "double")
    expect_type(xf_raw$pH_light, "double") # Note: this is actually an integer and will be converted during preprocessing.
    expect_type(xf_raw$pH_dark, "double") # Note: this is actually an integer and will be converted during preprocessing.
    expect_type(xf_raw$pH_ref_light, "double") # Note: this is actually an integer and will be converted during preprocessing.
    expect_type(xf_raw$pH_ref_dark, "double") # Note: this is actually an integer and will be converted during preprocessing.
    expect_type(xf_raw$pH_em_corr, "double")
  })
}
